...
BEGIN
    ...
    PLOG_INTERFACE.log(pCTX, pID, pLDate, pLHSECS, pLLEVEL, pLSECTION, pLUSER, LLTEXT, pLTAG);
...
IS
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel(pLEVEL), pCTX => pCTX, pTEXT => pTEXT, pLTAG=>pLTAG);
END log;
...
IS
   generiqueCTX PLOGPARAM.LOG_CTX := getDefaultContext;
BEGIN
    LOG(pLEVEL => pLEVEL, pCTX => generiqueCTX, pTEXT => pTEXT, pLTAG=>pLTAG);
END log;
...
IS
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel(pLEVEL), pTEXT => pTEXT, pLTAG=>pLTAG);
END log;
...
IS
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('DEBUG'), pCTX => pCTX, pTEXT => pTEXT, pLTAG=>pLTAG);
END debug;
...
IS
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('DEBUG'), pTEXT => pTEXT, pLTAG=>pLTAG);
END debug;
...
IS
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('INFO'), pCTX => pCTX,  pTEXT => pTEXT, pLTAG=>pLTAG);
END info;
...
IS
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('INFO'),  pTEXT => pTEXT, pLTAG=>pLTAG);
END info;
...
IS
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('WARN'), pCTX => pCTX,  pTEXT => pTEXT, pLTAG=>pLTAG);
END warn;
...
IS
BEGIN
    LOG(pLEVEL => PLOGPARAM.getTextInLevel('WARN'),  pTEXT => pTEXT, pLTAG=>pLTAG);
END warn;
...
IS
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('ERROR'), pCTX => pCTX,  pTEXT => pTEXT, pLTAG=>pLTAG);
END error;
...
--******************************************************************************
BEGIN
    LOG(pLEVEL => PLOGPARAM.getTextInLevel('ERROR'),  pTEXT => pTEXT, pLTAG=>pLTAG);
END error;
...
IS
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('FATAL'), pCTX => pCTX,  pTEXT => pTEXT, pLTAG=>pLTAG);
END fatal;
...
IS
BEGIN
    log(pLEVEL => PLOGPARAM.getTextInLevel('FATAL'),  pTEXT => pTEXT, pLTAG=>pLTAG);
END fatal;
