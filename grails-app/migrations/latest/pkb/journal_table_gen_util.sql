...
--changeset yen:journal_table_gen_util_pkb  splitStatements:false runOnChange:true runAlways:true failOnError:true
...
/*
		...
		Requires: Create table and sequence privileges. Must be granted separately
		grant create table to $user;
		grant create sequence to $user;

		HOW TO USE:
		begin
			journal_table_gen_util.create_audit_table('train_composition');
			journal_table_gen_util.auto_modify_archive_table('train_composition');
			journal_table_gen_util.gen_audit_trg('train_composition');
		end;
*/
